                    ...
                    <AnimatePresence>
                        <Marquee speed={20}
                            ...
                            {wishes.map((wish, index) => (
                                ...
                                >
                                    {/* Background gradient */}
                                    <div className="absolute inset-0 bg-gradient-to-r from-amber-100/50 to-pink-100/50 rounded-xl transform transition-transform group-hover:scale-[1.02] duration-300" />

                                    {/* Card content */}
                                    <div className="relative backdrop-blur-sm bg-white/80 p-4 rounded-xl border border-amber-100/50 shadow-md">
                                        {/* Header */}
                                        <div className="flex items-start space-x-3 mb-2">
                                            {/* Avatar */}
                                            <div className="flex-shrink-0">
                                                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-amber-400 to-pink-400 flex items-center justify-center text-white text-sm font-medium">
                            ...
                            <div className='space-y-2'>
                                ...
                                >
                                    ...
                                    <button
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl bg-white/50 border border-amber-100 focus:border-amber-300 focus:ring focus:ring-amber-200 focus:ring-opacity-50 transition-all duration-200 text-left flex items-center justify-between"
                                    >
                                    ...
                                    <AnimatePresence>
                                        {isOpen && (
                                            <motion.div
                                                ...
                                                animate={{ opacity: 1, y: 0 }}
                                                exit={{ opacity: 0, y: -10 }}
                                                className="absolute z-10 w-full mt-1 bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden"
                                            >
                                                {options.map((option) => (
                                                    <motion.button
                                                        key={option.value}
