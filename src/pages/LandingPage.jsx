...
const LandingPage = ({ onOpenInvitation }) => (
  ...
  >
    ...
    <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-amber-100/20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2" />
    ...
    <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
      ...
      >
        {/* Card Container */}
        <div className="backdrop-blur-sm bg-white/50 p-6 sm:p-8 md:p-10 rounded-2xl border border-amber-100/50 shadow-xl">
          {/* Top Decorative Line */}
          ...
          >
            <motion.button
              ...
              // className="group relative w-full bg-amber-500 text-white px-6 py-3 sm:px-8 sm:py-3 rounded-xl font-medium shadow-lg hover:bg-amber-600 transition-all duration-200"
            ...
            >
              ...
              {/* <div className="absolute inset-0 bg-gradient-to-r from-amber-600 to-amber-500 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200" /> */}
